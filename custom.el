(custom-set-variables
 ...
 '(package-selected-packages
   '(anaphora avy battle-haxe bison-mode cargo company-flx company-irony company-jedi company-nginx company-solidity disable-mouse dockerfile-mode edit-indirect elixir-mode emojify fish-mode flycheck form-feed geiser  go-mode haxe-mode hcl-mode helm-company helm-lsp helm-projectile helm-rg helm-swoop helm-tramp hsluv hydra irony link-hint lorem-ipsum lsp-mode lsp-ui lua-mode magit merlin merlin-company merlin-eldoc mix multi-vterm multiple-cursors nginx-mode nix-mode python racer racket-mode reason-mode rspec-mode rustic s session slime-company solarized-theme solidity-mode term-projectile tide tuareg typescript-mode undo-tree use-package web-mode wgrep wgrep-helm yaml-mode yasnippet zig-mode))
