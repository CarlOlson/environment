...
function fish_prompt --description 'Write out the prompt'
    ...
    switch "$USER"
        ...
        case '*'
            set color_cwd $fish_color_cwd
            set suffix (set_color purple) ' » ' $normal
    end
    ...
    echo -n -s (set_color $fish_color_user) "$USER" $normal @ (set_color $fish_color_host) (prompt_hostname) $normal ' ' (set_color $color_cwd) (prompt_pwd) $normal $prompt_status $normal (__fish_vcs_prompt) $suffix
end
