...
#
# Created from:
# conda "shell.fish" "hook" $argv > conda.fish

set -gx CONDA_EXE "$HOME/anaconda3/bin/conda"
set _CONDA_ROOT "$HOME/anaconda3"
set _CONDA_EXE "$HOME/anaconda3/bin/conda"
set -gx CONDA_PYTHON_EXE "$HOME/anaconda3/bin/python"
