...
#+BEGIN_SRC emacs-lisp
  ;;; -*- lexical-binding: t -*-
  (assert (member system-type '(darwin gnu/linux)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun my/font (&optional frame)
    (with-selected-frame (or frame (selected-frame))
      (with-system sm
        (set-frame-font "-mlss-Anonymous Pro-bold-normal-normal-*-14-*-*-*-m-0-iso10646-1"))
      (with-system md
        (set-frame-font "-mlss-Anonymice Nerd Font Mono-normal-normal-normal-*-18-*-*-*-m-0-iso10646-1"))
      (with-system lg
        (set-frame-font "-mlss-Anonymous Pro-bold-normal-normal-*-24-*-*-*-m-0-iso10646-1"))))
  ...
  (defun my/keyboard-translations (&optional frame)
    (with-selected-frame (or frame (selected-frame))
      (with-system darwin
        ...
        (keyboard-translate ?\C-g 'tab)
        (keyboard-translate ?\C-t ?\C-p))
      (with-system linux
        (keyboard-translate ?\C-i 'tab))))
